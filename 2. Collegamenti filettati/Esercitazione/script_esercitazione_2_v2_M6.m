...
%SCELTA VITE DI TENTATIVO M6
d = 6; % diametro vite [mm]
D_testa = 10; % [mm] è minore della dimensione massima 14 mm
D_fori = d + 1; % [mm] 1 mm in più rispetto al diametro nominale
dist_min = 2.5*D_fori; % [mm] distanza minima tra i fori = 2.5 volte D
...
d2 = 5.350; % [mm] %diametro medio
d3 = 4.773; % [mm] %diametro nocciolo
p = 1; % [mm] passo
beta = deg2rad(30); 
...
MA = (d2/2)*((mu_vite/cos(beta))+(p/(pi*d2))+Dkm*mu_vite/d2)*F_m_max; % [N*mm]
